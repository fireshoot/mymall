...
<script type="text/javascript">
	...
	function add(num) {
		...
		var stock = parseInt("${pageVo.book.stock}");
		if (num == 1) {
	...
	<div class="container">
		...
		<div class="paixu">
			...
			<ul id="test_fu">
				...
				<li id="number22"><a href="${pageContext.request.contextPath}/book/title_sort_best.action?ispage=0&id=1&key=${key}&flag=${flag}&page=1">销量<b><img src="${pageContext.request.contextPath}/images/list_jtx.jpg"
							width="7" height="8"></b></a></li>
				<li id="number33"><a href="${pageContext.request.contextPath}/book/title_sort_best.action?ispage=0&id=2&key=${key}&flag=${flag}&page=1">价格<b><img src="${pageContext.request.contextPath}/images/list_jts.jpg"
							width="7" height="8"></b></a></li>
				<li id="number44"><a href="${pageContext.request.contextPath}/book/title_sort_best.action?ispage=0&id=3&key=${key}&flag=${flag}&page=1">出版时间<b><img src="${pageContext.request.contextPath}/images/list_jtx.jpg"
							width="7" height="8"></b></a></li>
			</ul>
		</div>
		<!--paixu end -->
		...
		<div class="today">
			...
			<div class="today_b">
				...
				<c:forEach items="${books}" var="dail" begin="${15*(Page-1)}"
					...
					varStatus="statue">
				<li><a href="${pageContext.request.contextPath}/book/item.action?bid=${dail.bid}" target="_blank">
					<div class="pics">
						...
						<div class="no_price">
							<span class="dj">定价：<del>￥${dail.price}</del></span><span class="yhj">优惠价<b>￥${dail.price}</b></span>
						</div>
				</a></li>
		...
		<div class="pages">
			...
			<a
				href="${pageContext.request.contextPath}/book/title_sort_best.action?ispage=1&id=${ID}&key=${key}&flag=${flag}&page=${Page-1}">&lt;&lt;上一页</a>
			<%
				...
				for (int i = 0; i < number / 15 + 1; i++) {
					...
					<a href="${pageContext.request.contextPath}/book/title_sort_best.action?ispage=1&id=${ID}&key=${key}&flag=${flag}&page=<%=j%>"><%=j%></a>
					<% 
				}
			%>
			<a
				href="${pageContext.request.contextPath}/book/title_sort_best.action?ispage=1&id=${ID}&key=${key}&flag=${flag}&page=${Page+1}">下一页
				&gt;&gt; </a>
			<%
