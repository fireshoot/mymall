   ...
   <div class="zhuce_c">
        ...
        <div class="password_b">
             ...
             <div class="password_bc">
                 <form action="${pageContext.request.contextPath}/customer/password3.action" method="post">
                  
                  <div class="password_bc2">
                  <div style="color: red;">${errMsg }</div>
                  <%Question q=(Question)session.getAttribute("question");
                  out.print("<div class='password_bc2t'>"+"问题二:"+q.getQuestion2()+"?"+"</div>");
                  %>
                       <div class="password_bc2b"><input type="text" name="answer2" class="password_bc2btxt"></div>
                       <div class="password_bc2c"><input  type="submit"  class="pass_next" value="验证"></div>
                  </div>
                  </form>
